  ...
  render() {
    return (
      ...
      >
        ...
        <p>Note that in reality there is no definitive set of calls that everyone follows to the letter - this interactive callguide only presents one version for each song that hits most of the common calls. You and the other livers in the concert or live viewing may do something minorly or majorly different <span className="small">(as long as you don't taiga)</span>.</p>
        <h2>Contact</h2>
